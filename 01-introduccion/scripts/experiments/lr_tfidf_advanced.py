"""Training pipeline for TF-IDF spam classification with advanced preprocessing.

This experiment uses advanced preprocessing (URL/email removal, lemmatization,
stopword filtering, POS tagging) to demonstrate the impact of linguistic feature selection.
...
def main():
    """Load dataset, train TF-IDF classifier with advanced preprocessing, and evaluate."""
    # ===== DATASET / PIPELINE =====

"""Training pipeline for SBERT MPNET embeddings-based spam classification.

This experiment uses SBERT with the all-mpnet-base-v2 model to generate semantic sentence embeddings.
...
from spam_ham_detector import SBERT, CommentsDataset, evaluate_metrics, print_experiment_summary, save_predictions
...
def main():
    ...
    embedder = SBERT(model_name='all-mpnet-base-v2')
    ...
    X_test_emb = embedder.embed_documents(dataset.X_test)
